...
/*
if(room != rm_titlescreen && room != rm_splashscreen){
...
if(room != rm_titlescreen && room != rm_splashscreen){
	new_x += (keyboard_check(ord("D")) - keyboard_check(ord("A")))*zoom_level*CAMERA_PAN_SPEED*(keyboard_check(vk_shift) ? 2 : 1)
	new_y += (keyboard_check(ord("S")) - keyboard_check(ord("W")))*zoom_level*CAMERA_PAN_SPEED*(keyboard_check(vk_shift) ? 2 : 1)
}
